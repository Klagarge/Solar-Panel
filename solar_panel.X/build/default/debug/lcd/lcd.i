...
int8_t Lcd_Init(void)
{
        ...
        _delay((unsigned long)((200)*(25000000L/4000.0)));
        LCD_2x16_WriteCmd(0x02);

        LCD_2x16_WriteCmd(0x28);


        LCD_2x16_WriteCmd(0x01);
...
{
    LATDbits.LATD3 = 0;
    LATJ = (command & 0xF0) | (LATJ & 0x0F);
    LATDbits.LATD2 = 1;
    _delay((unsigned long)((10)*(25000000L/4000000.0)));
    LATDbits.LATD2 = 0;
    _delay((unsigned long)((1)*(25000000L/4000000.0)));
    command = command << 4;
    LATJ = (command & 0xF0) | (LATJ & 0x0F);
    LATDbits.LATD2 = 1;
    _delay((unsigned long)((10)*(25000000L/4000000.0)));
    LATDbits.LATD2 = 0;
    _delay((unsigned long)((3)*(25000000L/4000.0)));
}
void LCD_2x16_WriteData(uint8_t command)
{
    LATDbits.LATD3 = 1;
    ...
    _delay((unsigned long)((1)*(25000000L/4000000.0)));
    LATDbits.LATD2 = 0;
    _delay((unsigned long)((100)*(25000000L/4000000.0)));
}
